function createAboutPage() {
	...
	const para1 = createPara(
		"In the 1970s, Jack decided to expand his operation, and turned the basement of his butcher shop into a full-fledged restaurant." +
	...
	const para2 = createPara(
		'Over the years, "The Bigger Better Burger Basement" became a destination for burger lovers from all over the country.' +
	...
	const para3 = createPara(
		'Today, "The Bigger Better Burger Basement" is still run by the descendants of Jack and has expanded to multiple locations, but the recipes and the passion for creating the perfect burger remains the same.' +
