function createHomePage() {
	...
	heading.textContent =
		"Hello and welcome to the BIGGER BETTER BURGER BASEMENT! \n Serving since '50s!";

	const para1 = createPara(
		"At Bigger Better Burger Basement, we pledge ourselves in offering you" +
			" the best goddamn burger you've ever had in your goddamn life."
	);
	const para2 = createPara(
		"Because let's be real, what's a bigger sin that feeling unsatiated after " +
			"a long day at work?"
	);
	const para3 = createPara(
		"That's why at BBBB, we don't just sell you burgers. We sell you our heart and soul. " +
	...
	const para5 = createPara(
		"Fill that ravenous appetite of yours through ordering online or visiting us " +
			"at Queenstown Burger St."
	);
	const para6 = createPara(
		"What are you waiting for? Hop over to our menu and drool helplessly over our the " +
